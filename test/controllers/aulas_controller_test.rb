...
class AulasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aula" do
    assert_difference('Aula.count') do
      post aulas_url, params: { aula: { bloque: @aula.bloque, capacidad: @aula.capacidad, nombre: @aula.nombre, observacion: @aula.observacion } }
    end
  ...
  test "should update aula" do
    patch aula_url(@aula), params: { aula: { bloque: @aula.bloque, capacidad: @aula.capacidad, nombre: @aula.nombre, observacion: @aula.observacion } }
